...
import com.amiba.frame.androidframe.TestBean;
...
public class TestKJActivity extends BaseActivity {

    public static final String TAG = TestKJActivity.class.getSimpleName();
    ...
    protected int getLayoutResId() {
        return R.layout.activity_test_jk;
    }
...
//        subscribeOn即被观察者的subscribe方法工作的线程
//        observeOn即观察者工作的线程
//        建议升级到新版本
        observable.subscribeOn(new IoScheduler()).observeOn(new SingleScheduler()).subscribe(observer);
    }
    ...
    public void testFileDownload() {
        FileCallBack fileCallBack = new FileCallBack(getApplicationContext().getExternalCacheDir().getAbsolutePath(), "zwd.apk") {
            ...
            public void inProgress(float progress, long total, int id) {
                ...
                showLoadingDialog("正在下载", R.drawable.b01);
            }
