...
public class TestBannerActivity extends BaseActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        viewPager = findViewById(R.id.id_vp_banner);
        viewPager.addOnPageChangeListener(this);// 设置页面更新监听
//		viewPager.setOffscreenPageLimit(1);// 左右各保留几个对象
        ll_point_container =  findViewById(R.id.id_ll_point_container);
