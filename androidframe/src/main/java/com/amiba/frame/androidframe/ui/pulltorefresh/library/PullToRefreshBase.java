...
import com.amiba.frame.androidframe.ui.pulltorefresh.library.internal.FlipLoadingLayout;
import com.amiba.frame.androidframe.ui.pulltorefresh.library.internal.LoadingLayout;
import com.amiba.frame.androidframe.ui.pulltorefresh.library.internal.RotateLoadingLayout;
import com.amiba.frame.androidframe.ui.pulltorefresh.library.internal.Utils;
import com.amiba.frame.androidframe.ui.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected void onRefreshing(final boolean doScroll) {
        ...
        if (doScroll) {
            if (mShowViewWhileRefreshing) {
                ...
                OnSmoothScrollFinishedListener listener = () -> callRefreshListener();
    ...
    private final void smoothScrollToAndBack(int y) {
        smoothScrollTo(y, SMOOTH_SCROLL_DURATION_MS, 0, () -> smoothScrollTo(0, SMOOTH_SCROLL_DURATION_MS, DEMO_SCROLL_INTERVAL, null));
    }
